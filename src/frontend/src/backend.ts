...
import type { Bot as _Bot, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createBot(arg0: string, arg1: string, arg2: Array<string>, arg3: string, arg4: string, arg5: string, arg6: string, arg7: bigint, arg8: string, arg9: string | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createBot(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg9));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteBot(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getBot(arg0: bigint): Promise<Bot> {
        if (this.processError) {
            try {
                const result = await this.actor.getBot(arg0);
                return from_candid_Bot_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getBots(): Promise<Array<Bot>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBots();
    ...
    async setStatus(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateBot(arg0: bigint, arg1: string, arg2: string, arg3: Array<string>, arg4: string, arg5: string, arg6: string, arg7: string, arg8: bigint, arg9: string, arg10: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBot(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg10));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Bot_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Bot): Bot {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        chatPersonality: value.chatPersonality
    };
}
...
function from_candid_vec_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Bot>): Array<Bot> {
    return value.map((x)=>from_candid_Bot_n4(_uploadFile, _downloadFile, x));
}
